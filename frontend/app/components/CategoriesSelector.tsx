...
import { Box, Checkbox, Chip, CircularProgress, FormControl, Grid, InputLabel, ListItemText, MenuItem, OutlinedInput, Select, SelectChangeEvent } from '@mui/material';
...
const CategoriesSelector = ({ categoryIdsSelected, onCategoryIdsSelectedChange }: CategoriesSelectorProps) => {
  const { data: categories = [], isLoading: getCategoriesLoading, error: getCategoriesError } = useQuery<{ id: number; category_name: string }[]>({
