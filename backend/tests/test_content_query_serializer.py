...
class TestContentQuerySerializer(TestCase):
    def test_valid_content_types(self):
        for content_type, _ in ContentItem.CONTENT_TYPE_CHOICES:
            serializer = ContentQuerySerializer(data={'content_type': content_type, 'course_scan_id': 1})
    ...
    def test_invalid_content_type(self):
        serializer = ContentQuerySerializer(data={'content_type': 'invalid_type', 'course_scan_id': 1})
